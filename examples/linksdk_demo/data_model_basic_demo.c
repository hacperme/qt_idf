...
/* TODO: 替换为自己设备的三元组 */
char *product_key       = "a1ox6SbM4ri";
char *device_name       = "test1";
char *device_secret     = "1b65e15f995edf3e6a086cce3d4cb353";
...
*/
char  *mqtt_host = "a1ox6SbM4ri.iot-as-mqtt.cn-shanghai.aliyuncs.com";
...
int main(int argc, char *argv[])
{
    ...
    aiot_mqtt_sub(mqtt_handle, "/sys/a1ox6SbM4ri/test1/thing/event/property/batch/post_reply", NULL, 1,
                  NULL);
    ...
    while (1) {
        ...
        demo_send_property_post(dm_handle, "{\"net_type\": 4}");
        /*
